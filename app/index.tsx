          ...
          <View className={"flex flex-col items-center justify-center p-4 gap-2 min-h-[80vh]"}>
              ...
              { storage && storage.length > 0 ?
                  ...
                  <FlatList
                      ...
                      renderItem={ (i: any) =>  {
                          return (
                              <View className={`${i.index === storage.length  ? "mb-16" : ""} flex flex-col items-center justify-between my-2 border border-gray-200 p-4 bg-transparent rounded-2xl max-w-full w-full`}>
